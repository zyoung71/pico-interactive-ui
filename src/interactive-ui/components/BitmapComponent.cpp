...
BitmapComponent::BitmapComponent(const ScreenManager* manager, const Vec2i32& origin, const Vec2i32& dimensions, uint32_t* pixels, int32_t z_layer, const Screen* initial_screen)
...
BitmapComponent::BitmapComponent(const ScreenManager* manager, float x_percentage, float y_percentage, const Vec2i32& dimensions, uint32_t* pixels, int32_t z_layer, const Screen* initial_screen)
...
BitmapComponent::BitmapComponent(const ScreenManager* manager, const Vec2i32& origin, const ArrayView2D<uint32_t>& pixels, int32_t z_layer, const Screen* initial_screen)
